...
At this stage in India, a realistic structure for a hunting sales lead is a base in the Rs 15 to 22 lakh range, with a variable component that can bring total comp to Rs 28 to 38 lakh at target.
...
Do not pay a Rs 35 lakh base to someone whose variable is an afterthought. You will create a salaried pipeline manager, not a hunter.
