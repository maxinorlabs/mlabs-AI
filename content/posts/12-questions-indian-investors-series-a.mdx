...
If you want to understand the wider funding environment before diving in, [the Series A drought and what it means for operator-led Venture](/blog/series-a-drought-operator-led-Venture-india) gives useful context on why the bar has risen so sharply since 2022.
...
Indian Series A investors in 2026 are generally looking for ₹3 Cr–₹12 Cr in ARR (roughly $350K to $1.4M), depending on the sector and business model. For B2B SaaS, the floor is typically ₹4 Cr. For marketplace or transactional models, investors weight GMV growth alongside revenue. A company at ₹2 Cr ARR growing at 15% month-on-month will get more attention than one at ₹5 Cr growing at 4%.
...
For Indian B2B Venture, the target benchmarks in 2026 are:
...
Most Indian Series A investors want to see a credible path to ₹100 Cr–₹500 Cr in revenue within 5-7 years from the round. The TAM needs to be large enough to support that trajectory without requiring the company to win an implausible market share.
...
The pattern across all twelve questions is the same. Investors are testing operational clarity. They want to know whether the founder running this business has a precise, evidence-based understanding of how it works, why it works, and what will make it work better with more capital. For a broader view of the investor lens, [what investors look for in Indian Venture](/blog/what-investors-look-for-indian-Venture) provides context beyond the Series A metrics checklist.
