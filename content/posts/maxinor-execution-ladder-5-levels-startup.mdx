...
This is what [execution capital](/blog/execution-capital-vs-venture-capital-india) enables: the transformation from a founder-driven company that happens to have systems into a systems-driven company that has an exceptional founder.
