...
Maxinor's operator engagements follow this structure. Operators embedded through the [Venture Scale](/scale) programme work on milestone-linked 3 to 12 month engagements inside portfolio companies, owning specific functions with specific outcome criteria. The engagement is not open-ended advisory. It is defined, accountable, and measured in business results.
