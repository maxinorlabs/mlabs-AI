    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <span style={{ fontSize: '14px', fontWeight: 700, color: '#F36F21', letterSpacing: '0.2em', textTransform: 'uppercase', fontFamily: 'sans-serif' }}>Venture Build</span>
          ...
          <p style={{ fontSize: '22px', color: 'rgba(247,247,245,0.5)', fontFamily: 'sans-serif', fontWeight: 400, margin: 0, paddingLeft: '25px' }}>
            From validated white space to funded company
          </p>
        </div>

        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <div style={{ display: 'flex', gap: '12px' }}>
            {['Ideation', 'Product', 'GTM', 'Team Assembly'].map((tag) => (
