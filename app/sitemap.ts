...
const pageRoutes = [
  ...
  { path: '/domains/media', priority: 0.8, changeFrequency: 'monthly' as const },
  { path: '/domains/d2c', priority: 0.8, changeFrequency: 'monthly' as const },
  { path: '/domains/healthcare', priority: 0.8, changeFrequency: 'monthly' as const },
  { path: '/domains/education', priority: 0.8, changeFrequency: 'monthly' as const },
  { path: '/domains/marketing', priority: 0.8, changeFrequency: 'monthly' as const },
  { path: '/domains/legal', priority: 0.8, changeFrequency: 'monthly' as const },
  ...
  { path: '/capabilities/revenue-gtm', priority: 0.8, changeFrequency: 'monthly' as const },
