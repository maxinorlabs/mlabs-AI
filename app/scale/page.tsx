...
const engines = [
  {
    ...
    items: [
      ...
      'Sales playbook and pipeline design',
  ...
  },
  {
    ...
    items: [
      ...
      'Vendor and procurement optimisation',
      'Reporting infrastructure and dashboards',
    ],
  },
  {
    title: 'Product and Design Engine',
    accent: 'teal',
    items: [
      'Product strategy and roadmap prioritisation',
      'UX audit and redesign',
      'Growth and retention systems',
      'AI integration and product intelligence',
      'Product operations and sprint cadence',
      'Feature prioritisation frameworks',
    ],
  },
  {
    title: 'AI and Data Engine',
    accent: 'purple',
    items: [
      'Agentic AI and workflow automation',
      'Data platform and infrastructure',
      'Business intelligence and reporting',
      'AI use-case identification and build',
      ...
      <section className="border-t border-grey/10 bg-white px-6 py-20 md:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <h2 className="max-w-2xl text-3xl font-display font-medium tracking-tight text-navy md:text-4xl lg:text-5xl">
              Four operator engines. One system.
            </h2>
          </motion.div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {engines.map((engine, i) => {
              ...
              return (
                ...
                >
                  <div className={`mb-5 inline-block rounded-full px-3 py-1 text-[11px] font-bold uppercase tracking-[0.16em] ${ac.badge}`}>
