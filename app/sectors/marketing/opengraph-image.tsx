    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <span style={{ fontSize: '14px', fontWeight: 700, color: '#F36F21', letterSpacing: '0.2em', textTransform: 'uppercase', fontFamily: 'sans-serif' }}>Domain · Marketing</span>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px' }}>
            ...
            <span style={{ fontSize: '46px', fontWeight: 700, color: '#F7F7F5', lineHeight: 1.1, fontFamily: 'sans-serif', letterSpacing: '-0.02em' }}>
              {'Your brand is visible. The conversion\nrate tells a different story.'}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <div style={{ display: 'flex', gap: '10px' }}>
            {['Brand Strategy', 'Consumer Marketing', 'Content', 'Growth'].map((tag) => (
