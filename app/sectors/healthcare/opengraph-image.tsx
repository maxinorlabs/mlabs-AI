    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <span style={{ fontSize: '14px', fontWeight: 700, color: '#F36F21', letterSpacing: '0.2em', textTransform: 'uppercase', fontFamily: 'sans-serif' }}>Sector · Healthcare</span>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px' }}>
            <div style={{ width: '5px', height: '80px', background: '#F36F21', borderRadius: '4px', flexShrink: 0, marginTop: '6px' }} />
            <span style={{ fontSize: '50px', fontWeight: 700, color: '#F7F7F5', lineHeight: 1.1, fontFamily: 'sans-serif', letterSpacing: '-0.02em' }}>
              {'Healthcare technology is not a product problem.\nIt is a deployment problem.'}
            </span>
          </div>
          <p style={{ fontSize: '22px', color: 'rgba(247,247,245,0.5)', fontFamily: 'sans-serif', fontWeight: 400, margin: 0, paddingLeft: '25px' }}>
            HealthTech and Clinical Tools
          </p>
        </div>

        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <div style={{ display: 'flex', gap: '10px' }}>
            {['HealthTech', 'Hospital Sales', 'Clinical SaaS', 'MedTech'].map((tag) => (
