    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <span style={{ fontSize: '14px', fontWeight: 700, color: '#F36F21', letterSpacing: '0.2em', textTransform: 'uppercase', fontFamily: 'sans-serif' }}>Sector · Education</span>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px' }}>
            ...
            <span style={{ fontSize: '46px', fontWeight: 700, color: '#F7F7F5', lineHeight: 1.1, fontFamily: 'sans-serif', letterSpacing: '-0.02em' }}>
              {'You have learners. Employers do not\nrecognise your outcomes yet.'}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <div style={{ display: 'flex', gap: '10px' }}>
            {['Completion Rates', 'Institutional Sales', 'Credentialing', 'B2B EdTech'].map((tag) => (
