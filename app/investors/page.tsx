...
export default function InvestorsPage() {
  const benefits = [
    {
      icon: <TrendingUp className="w-7 h-7 md:w-8 md:h-8 text-brand" />,
      title: "High-Growth Potential",
      desc: "Access to a curated pipeline of operator-vetted startups with strong fundamentals and clear paths to scale."
    },
    {
      icon: <ShieldCheck className="w-7 h-7 md:w-8 md:h-8 text-brand" />,
    ...
    {
      icon: <Users className="w-7 h-7 md:w-8 md:h-8 text-brand" />,
    ...
    {
      icon: <BarChart3 className="w-7 h-7 md:w-8 md:h-8 text-brand" />,
  ...
  return (
    <div className="pt-24 md:pt-32 pb-24 md:pb-32 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-1 gap-12 mb-16 md:mb-32 items-start">
          <div className="space-y-6 md:space-y-8">
            <h2 className="text-2xl md:text-3xl font-display font-medium tracking-tight">Why Invest With Us?</h2>
            <p className="text-grey text-base md:text-lg leading-relaxed font-light">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 md:pt-6">
              {benefits.map((benefit, idx) => (
                <div key={idx} className="p-6 md:p-8 bg-white border border-grey/30 rounded-[2rem] hover:bg-white transition-colors duration-500">
        ...
        <div className="bg-white border border-grey/30 rounded-[2rem] p-8 md:p-12 flex flex-col justify-center relative overflow-hidden mb-16 md:mb-32">
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-brand/10 blur-[80px] rounded-full pointer-events-none" />
          <div className="relative z-10">
            <h3 className="text-xl md:text-2xl font-display font-medium mb-6 md:mb-8">Investment Opportunities</h3>
            <ul className="grid md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-10">
              <li className="flex items-start gap-4">
                <div className="w-2 h-2 rounded-full bg-brand mt-2.5 shrink-0" />
                <div>
                  <h4 className="font-medium text-base md:text-lg mb-1">Venture Fund</h4>
              ...
              <li className="flex items-start gap-4">
                <div className="w-2 h-2 rounded-full bg-brand mt-2.5 shrink-0" />
                <div>
                  <h4 className="font-medium text-base md:text-lg mb-1">Syndicate & Co-Investments</h4>
              ...
              <li className="flex items-start gap-4">
                <div className="w-2 h-2 rounded-full bg-brand mt-2.5 shrink-0" />
                <div>
                  <h4 className="font-medium text-base md:text-lg mb-1">Equity Crowdfunding (ECF)</h4>
            ...
            <div className="flex justify-center">
              <Link href="/contact" className="inline-flex items-center justify-center gap-2 bg-brand text-warm-white font-semibold tracking-wide rounded-full px-8 py-4 sm:px-10 sm:py-5 text-base sm:text-lg hover:bg-brand/90 transition-all duration-300 whitespace-nowrap hover:-translate-y-1 shadow-[0_0_40px_rgba(243,111,33,0.15)] hover:shadow-[0_0_60px_rgba(243,111,33,0.3)]">
                Join Our Investor Network <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" />
              </Link>
            </div>
          </div>
        </div>
