...
const painPoints = [
  {
    ...
    body: 'Most AI engagements end in a polished deck and a dormant prototype. Without operator ownership of the full build and deployment cycle, AI stays permanently in evaluation mode and never touches the business.',
  },
  {
    icon: GitBranch,
    number: '02',
    title: 'No Clear Use Case',
    body: 'Founders and leadership teams are sold on AI potential without a prioritised roadmap tied to actual business problems. The result is scattered investment across ten initiatives, none of which reaches production quality.',
  },
  {
    icon: Layers,
    number: '03',
    title: 'Tech Debt That Kills Scale',
    body: 'AI built without architecture discipline becomes a liability at Series A. Poor data pipelines, brittle model dependencies, and undocumented systems cause the exact slowdown founders were trying to avoid.',
  },
];
...
const architecture = [
  {
    tier: 'Strategy Layer',
    description: 'Where you start before writing a line of code',
    accent: 'border-teal-500',
    labelColor: 'text-teal-600',
    groups: [
      {
        label: 'AI Readiness',
        items: ['Data Maturity', 'Infrastructure Audit', 'Team Assessment', 'Use-Case Mapping', 'ROI Prioritisation'],
      },
      {
        label: 'AI Strategy',
        items: ['Adoption Roadmap', 'Build vs Buy', 'Governance Framework', 'Risk Assessment', 'Compliance Mapping'],
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        items: ['ETL Pipelines', 'Feature Stores', 'Data Lakes', 'Real-time Streams', 'Data Quality', 'Lineage Tracking'],
      },
      {
        label: 'Data Governance',
        items: ['Cataloguing', 'Access Control', 'Privacy & GDPR', 'Retention Policy', 'Audit Logging', 'Schema Management'],
      },
    ],
  },
  {
    tier: 'Model Layer',
    description: 'Where AI is actually built',
    accent: 'border-indigo-400',
    labelColor: 'text-indigo-500',
    groups: [
      {
        label: 'Model Development',
        items: ['LLM Fine-tuning', 'Custom ML Models', 'NLP', 'Computer Vision', 'Forecasting', 'Recommendation Systems'],
      },
      {
        label: 'Agentic AI',
        items: ['Agent Architecture', 'Workflow Automation', 'Tool Use', 'Memory Systems', 'Multi-agent Orchestration', 'RAG Systems'],
      },
    ],
  },
  {
    tier: 'Integration Layer',
    description: 'How AI connects to your business',
    accent: 'border-purple-400',
    labelColor: 'text-purple-500',
    groups: [
      {
        label: 'Product Integration',
        items: ['API Design', 'SDK Development', 'Embedding AI in UX', 'A/B Testing Framework', 'Feature Flags', 'Analytics Hooks'],
      },
      {
        label: 'Operations',
        items: ['Sales AI', 'Support Automation', 'Finance Intelligence', 'HR Automation', 'Marketing AI', 'Ops Dashboards'],
      },
    ],
  },
  {
    tier: 'MLOps Layer',
    description: 'How you keep AI working in production',
    accent: 'border-rose-400',
    labelColor: 'text-rose-500',
    groups: [
      {
        label: 'Deployment',
        items: ['CI/CD for ML', 'Cloud Deployment', 'Edge Inference', 'Containerisation', 'Model Registry', 'Rollback Strategy'],
      },
      {
        label: 'Monitoring',
        items: ['Performance Tracking', 'Drift Detection', 'Retraining Triggers', 'Cost Monitoring', 'SLA Dashboards', 'Incident Response'],
      },
    ],
  },
];
...
const verticals = [
  {
    name: 'AI for FinTech',
    desc: 'Risk models, fraud detection, underwriting automation, and compliance intelligence for lending and payments.',
  },
  {
    name: 'AI for Healthcare',
    desc: 'Clinical workflow automation, predictive diagnostics support, patient engagement, and medical data intelligence.',
  },
  {
    name: 'AI for D2C & Retail',
    desc: 'Personalisation engines, demand forecasting, inventory optimisation, and AI-native customer support.',
  },
  {
    name: 'AI for Media',
    desc: 'AI-native content operations, recommendation systems, audience intelligence, and automated production workflows.',
  },
  {
    name: 'AI for SaaS Platforms',
    desc: 'AI feature development, churn prediction, product analytics, and intelligent onboarding systems.',
  },
  {
    name: 'AI for Operations',
    desc: 'Process automation, intelligent reporting, back-office AI, and agentic workflow systems.',
  },
];
    ...
    <div className="font-sans">
      ...
      <section className="relative overflow-hidden bg-navy px-6 pt-32 pb-24 md:pt-44 md:pb-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            Your AI pilot shipped. It never moved a single business number.{' '}
            <span className="text-brand">We build AI that ships to production, not slide decks.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Most AI engagements produce a proof of concept and a report. Maxinor operators embed inside your team and build AI systems that are in production, driving measurable business outcomes, within 90 days.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="bg-warm-white px-6 py-20 md:py-28">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.22em] text-brand">Where AI Programmes Fail</p>
            <h2 className="max-w-2xl text-3xl font-display font-medium tracking-tight text-navy md:text-4xl">
              Three reasons AI never moves the business needle.
            </h2>
          </motion.div>
      ...
      <section className="bg-warm-white px-6 py-20 md:py-28 border-t border-grey/10">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            className="mb-14 md:mb-16"
          >
            <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.22em] text-brand">Where We Apply AI</p>
            <h2 className="max-w-2xl text-3xl font-display font-medium tracking-tight text-navy md:text-4xl">
              Who we build AI for.
            </h2>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="max-w-2xl text-3xl font-display font-medium tracking-tight text-warm-white md:text-4xl">
              Operators who have shipped AI to production, not just advised on it.
            </h2>
          </motion.div>
            ...
            >
              <div className="mb-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-brand/80">Entrepreneur in Residence, AI & Technology</p>
                  <p className="text-xs text-warm-white/40">ex-Zee, ex-Oracle, ex-StanChart</p>
                </div>
              </div>
              <p className="text-sm font-light leading-relaxed text-warm-white/60">
                Technology leader with deep experience building and shipping AI systems inside large enterprises and growth-stage companies. Alok brings architecture discipline and production accountability to every AI engagement.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <h2 className="mb-5 text-3xl font-display font-medium tracking-tight text-navy md:text-5xl">
              Building something AI needs to power?
            </h2>
            <p className="mb-8 max-w-xl mx-auto text-base font-light leading-relaxed text-grey md:text-lg">
              Whether you are starting your AI journey, have a pilot that never shipped, or need to rebuild your AI layer with proper architecture, start here.
            </p>
