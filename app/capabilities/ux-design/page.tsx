...
import { ArrowRight, Search, Palette, Layout, MousePointer2, Smartphone, Shield } from 'lucide-react';
...
const offerings = [
  {
    icon: Search,
    title: 'UX Research',
    body: 'User interviews, usability studies, journey mapping, and the insight layer that makes design decisions defensible rather than based on assumptions or internal opinions.',
  },
  {
    icon: Palette,
    title: 'Product Design',
    body: 'End-to-end product design from concept through high-fidelity screens. Every design decision is tied to a user need and a business outcome.',
  },
  {
    icon: Layout,
    title: 'Design Systems',
    body: 'Scalable component libraries and design tokens that give your product visual and interaction consistency across every surface it touches.',
  },
  {
    icon: MousePointer2,
    title: 'Interaction Design',
    body: 'Micro-interactions, transitions, and the motion layer that makes products feel fast, responsive, and worth coming back to.',
  },
  {
    icon: Smartphone,
    title: 'Mobile UX',
    body: 'Touch-first design for iOS and Android that accounts for the unique constraints of mobile user behaviour and the diversity of device sizes your users actually own.',
  },
  {
    icon: Shield,
    title: 'Accessibility and Compliance',
    body: 'WCAG-aligned design that meets compliance requirements and reaches every user, including those your competitors are not designing for.',
  },
];
...
const differentiators = [
  {
    ...
    body: 'Every design decision is grounded in user behaviour data, not assumptions. We run research before we open a design tool.',
  },
  {
    number: '02',
    title: 'Business Metric Alignment',
    body: 'We design to conversion rate, activation rate, and retention metrics. Aesthetics are a means to an outcome, not the outcome.',
  },
  {
    number: '03',
    title: 'Systems Thinking',
    body: 'We build design systems that scale across your product, not one-off screens that fragment into inconsistency as the product grows.',
  },
  {
    number: '04',
    title: 'Developer-Ready Output',
    body: 'Every handoff includes documentation, tokens, and specifications your engineers can implement without interpretation.',
  },
];
...
const industries = [
  {
    ...
    desc: 'Onboarding flows, trust-building interfaces, and the UX that converts sceptical users into active customers in a high-regulation category.',
  },
  {
    name: 'Healthcare and Wellness',
    desc: 'Patient-facing and clinician-facing design that balances compliance requirements with the simplicity high-stress users need.',
  },
  {
    name: 'D2C and Consumer',
    desc: 'Discovery, consideration, and checkout flows designed to reduce friction and increase the revenue-per-visitor your brand earns.',
  },
  {
    name: 'EdTech',
    desc: 'Learning experiences designed for engagement and completion, not just enrolment. UX that keeps learners returning session after session.',
  },
  {
    name: 'B2B SaaS',
    desc: 'Activation, onboarding, and core workflow design for software that has to justify its seat in a competitive renewal conversation.',
  },
  {
    name: 'Consumer Apps',
    desc: 'Retention-oriented UX for consumer applications where the difference between Day 1 and Day 30 is almost always a design decision.',
  },
];
    ...
    <div className="font-sans">
      ...
      <section className="relative overflow-hidden bg-navy px-6 pt-32 pb-24 md:pt-44 md:pb-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            Users arrive.{' '}
            <span className="text-brand">They are not staying. That is a design problem.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Design is not decoration. It is the layer between your product and your business outcome. Every drop-off, every failed activation, every support ticket is a design signal. We build experiences that convert, retain, and reduce friction at every touchpoint.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            {['Research-Led', 'System-Thinking', 'Mobile-First', 'Accessible'].map((label) => (
              <div
                key={label}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="mb-4 max-w-2xl text-3xl font-display font-medium tracking-tight text-navy md:text-4xl">
              Six design capabilities. One coherent product experience.
            </h2>
            <p className="max-w-xl text-base font-light leading-relaxed text-grey">
              From research through design systems, we cover the full UX discipline with the rigour that turns product design into a business advantage.
            </p>
          </motion.div>
      ...
      <section className="bg-white px-6 py-20 md:py-28 border-t border-grey/10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="max-w-xl text-base font-light leading-relaxed text-grey">
              Most design engagements optimise for how the product looks. We optimise for what it does to your business metrics.
            </p>
          </motion.div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="mb-5 text-3xl font-display font-medium tracking-tight text-warm-white md:text-5xl">
              Ready to turn design into a growth lever?
            </h2>
            <p className="mb-10 text-base font-light leading-relaxed text-warm-white/60 md:text-lg">
              Whether you are starting from a wireframe or redesigning a product that users are leaving, the conversation starts with understanding why.
            </p>
